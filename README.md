#Demo for Victory Charts

React component based
Components render SVGs
...
Library is pretty heavy
Charts more customisable than canvas rendered charts
Some styles missing from types.
